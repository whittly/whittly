...
export const CATALOG: Tool[] = [
  ...
  // {cat: 'convert', icon: 'ti-arrows-shuffle', name: 'yaml ↔ json', desc: 'two-way converter with comments preserved'},
  ...
  // {cat: 'convert', icon: 'ti-markdown', name: 'markdown → html', desc: 'render with github-flavor extensions'},
  // {cat: 'convert', icon: 'ti-ruler', name: 'unit converter', desc: 'length, weight, temperature, data'},
  // {cat: 'convert', icon: 'ti-currency-dollar', name: 'currency', desc: 'live rates, 50+ currencies'},
  // {cat: 'convert', icon: 'ti-palette', name: 'color converter', desc: 'hex, rgb, hsl, oklch, lab'},
  ...
  // {cat: 'format', icon: 'ti-sql', name: 'sql formatter', desc: 'reformat any sql dialect cleanly', new: true},
  // {cat: 'format', icon: 'ti-brand-html5', name: 'html formatter', desc: 'indent, minify, validate'},
  // {cat: 'format', icon: 'ti-brand-css3', name: 'css formatter', desc: 'sort properties, expand shorthands'},
  // {cat: 'format', icon: 'ti-file-code', name: 'xml formatter', desc: 'pretty-print, validate against xsd'},
  // {cat: 'format', icon: 'ti-code', name: 'js beautifier', desc: 'unminify and format messy js'},
  // {cat: 'format', icon: 'ti-brand-typescript', name: 'ts formatter', desc: 'prettier rules, configurable'},
  // {cat: 'format', icon: 'ti-brand-yaml', name: 'yaml formatter', desc: 'normalize, sort keys, validate'},
  ...
  // {cat: 'encode', icon: 'ti-hash', name: 'hex encoder', desc: 'string ↔ hex bytes, choose encoding'},
  ...
  // {cat: 'generate', icon: 'ti-text-size', name: 'lorem ipsum', desc: 'paragraphs, words, lists'},
  {cat: 'generate', icon: 'ti-password', name: 'password generator', desc: 'configurable length, charset, entropy score', shortcut: 'P', new: true},
  // {cat: 'generate', icon: 'ti-qrcode', name: 'qr code', desc: 'svg, png, custom colors'},
  // {cat: 'generate', icon: 'ti-spy', name: 'fake data', desc: 'names, emails, addresses for testing'},
  ...
  // {cat: 'text', icon: 'ti-pilcrow', name: 'word counter', desc: 'characters, words, lines, reading time'},

  // network
  // {cat: 'network', icon: 'ti-key', name: 'jwt inspector', desc: 'inspect tokens and claims'},
  // {cat: 'network', icon: 'ti-network', name: 'cidr calculator', desc: 'subnet math, range, mask, hosts'},
  // {cat: 'network', icon: 'ti-world', name: 'dns lookup', desc: 'a, aaaa, mx, txt, ns records'},
  // {cat: 'network', icon: 'ti-server', name: 'http status', desc: 'codes, meanings, common pitfalls'},

  // image
  // {cat: 'image', icon: 'ti-photo', name: 'image → webp', desc: 'batch convert, control quality', new: true},
  // {cat: 'image', icon: 'ti-vector-bezier-2', name: 'svg optimizer', desc: 'svgo in-browser, presets'},
